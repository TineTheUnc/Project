...
CREATE TABLE `Estimate` (
  ...
  `Estimate_data` json NOT NULL,
  `Estimate_staff` int NOT NULL,
  `Estimate_create` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  PRIMARY KEY (`Estimate_id`),
  KEY `Estimate_Estimate_staff_fkey` (`Estimate_staff`),
  CONSTRAINT `Estimate_Estimate_staff_fkey` FOREIGN KEY (`Estimate_staff`) REFERENCES `User` (`User_id`) ON DELETE RESTRICT ON UPDATE CASCADE
...
INSERT INTO `Estimate` VALUES (3,'{\"accuracy\": 1, \"teamwork\": 0, \"diligence\": 1, \"punctuality\": 1, \"responsibility\": 1}',2,'2026-01-30');
...
INSERT INTO `User` VALUES (1,'Admin','Admin@email.com','123','admin',NULL),(2,'test1','test1@email.com','123','staff','/uploads/avatars/2.jpeg');
...
-- Dump completed on 2026-01-30  9:05:22
